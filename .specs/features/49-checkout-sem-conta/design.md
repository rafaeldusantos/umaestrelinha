...
**`AD-034`** em `.specs/STATE.md`, que nomeia `AD-023` e diz exatamente qual metade dele foi
estreitada.
...
> **`AD-034`** (a escrever em `.specs/STATE.md`): o checkout de convidada cria conta sem senha e o
