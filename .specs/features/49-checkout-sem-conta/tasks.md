...
**What**: baselines remedidas, guardas novos na tabela, `AD-034`, e as dívidas declaradas.
...
- [ ] `AD-034` escrito em `.specs/STATE.md`, nomeando `AD-023` e dizendo **qual metade** foi estreitada
