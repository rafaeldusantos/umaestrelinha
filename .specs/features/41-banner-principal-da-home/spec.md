...
| Proporção da arte de **computador** | ~~1440 × 540 (8:3)~~ → **1680 × 560 (3:1)** | **Medida contra a arte real da Adri em 2026-09-11**, que é a do site anterior — é de lá que ela traz a campanha. A suposição custou **90px cortados de cada lado**, comendo a primeira letra da frase desenhada dentro da arte. O painel **avisa** a divergência, não recusa (mesma régua de `HOME-27`) — mas apontava para o número errado | **s — medida, 2026-09-11** |
| Proporção da arte de **celular** | ~~780 × 975 (4:5)~~ → **720 × 720 (1:1)** | **Medida contra a arte real**, idem. O que `BNR-26` compra não era "retrato" e sim **altura de leitura em 390px**: o quadrado entrega 390px de altura, e é a tira 3:1 (130px) que a régua precisa recusar. A régua antiga (`height > width`) teria **reprovado a arte da dona** | **s — medida, 2026-09-11** |
