...
const CategoryFiltersSheet = ({
  ...
  <Sheet open={open} onOpenChange={onOpenChange}>
    ...
    >
      <span aria-hidden className="mx-auto mb-3 h-1 w-10 shrink-0 rounded-pill bg-nanita-border" />

      <div className="flex items-center justify-between pb-5">
        <div className="flex items-center gap-2">
          <SlidersHorizontal className="h-[18px] w-[18px] text-nanita-ink" strokeWidth={2} />
          <SheetTitle className="font-display text-[22px] font-semibold leading-7 text-nanita-ink">
            Filtros
          </SheetTitle>
        </div>
        <button
          ...
          className="text-[13px] font-semibold text-nanita-jam"
        >
          Limpar tudo
        </button>
      </div>
      ...
      <div className="flex gap-3 pt-4">
        <button
          type="button"
          onClick={() => onChange(defaultFilters(bounds))}
          className="flex h-[50px] flex-1 items-center justify-center rounded-[14px] bg-nanita-sugar text-[14px] font-semibold text-nanita-ink"
        >
          Limpar
        </button>
        <button
          ...
          className="flex h-[50px] flex-[2] items-center justify-center rounded-[14px] bg-nanita-jam text-[14px] font-bold text-white"
        >
